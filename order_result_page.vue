<template>
    <div class="wrap_flex_main js-main pc-w-mini">
        ...
        <div class="result_page_block">
            <div class="order_result_title">주문완료</div>
            <div class="order_result_block_1"><span class="address" >{{address}}</span> / <span class="order_user_name">{{orderUserName}}</span></div>
            <div class="order_result_block_2">(으)로 보내실 주문이 완료되었습니다.</div>
            <span class="my_btn btn-primary  go_to_product_list">닫기</span>
        </div>
</template>
<script>
    ...
    module.exports = {
        ...
        methods: {
            ...
            setOrderDetail: async function () {
                ...
                this.address = orderData.recipient_address;
